...
<a-asset-item id="why-male-models" src="man.glb"></a-asset-item>
  <img id="fall" src="images/fall.png">
  <img id="goggles" src="images/goggles.png">
  ...
  <a-entity  
    id="model" 
    position="0 0 -3" 
    animation="property: rotation; from: 0 -30 0;
    to: 0 330 0; 
    dur: 15000; 
    easing: linear; 
    loop: true"
  ...
  <a-image 
    ...
    height="3.5" 
    scale="0.2 0.2 0.2" 
    animation="property: position; from: 0 2.8 -6; to: 2.25 2.8 -6; delay: 1000; dur: 1000">
  </a-image>
  <a-cylinder 
    id="goggles" 
    color="#101010" 
  ...
  <a-curvedimage 
    id="stereoscopic-fall-collection-text" 
    src="#fall" 
    radius="5.7" 
    theta-length="18" 
    height=".45" 
    position="0 0.9 0" 
    scale=".4 .4 .4" 
    animation="property: rotation; from: 0 180 0; to: 0 210 0; delay: 750; dur: 1000">
  </a-curvedimage>
  <a-curvedimage 
    id="shoes" 
    src="#shoes" 
